...
import numpy as np
import random
from src.style_transfer.utils.Dataset import SingleImageDataset
from src.style_transfer.utils.model_splice import Model
from src.style_transfer.utils.losses import LossG
from src.style_transfer.utils.util import get_scheduler, get_optimizer, save_result
import yaml
...
def train_model(dataroot, callback=None):
    with open("src/style_transfer/utils/config_splice.yaml", "r") as f:
